  ...
  return (
    <div>
      <nav>
        ...
        <div className="hidden md:flex bg-[#FF5F15] justify-between items-center px-5 py-1">
        ...
        <div className="bg-[#FF5F15] px-3 py-1 flex justify-between items-center md:hidden">
          <div className="flex gap-3 items-center">
            <div>
              <a href="/">
                <Image
          ...
          <div
            className={
              menu
                ? ` h-full w-1/2 absolute top-0 right-0 bg-[#FF5F15] z-50`
                : `hidden`
            }
          >
            <RxCross2
