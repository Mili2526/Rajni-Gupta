  ...
  return (
    ...
    <div className="px-8  md:flex gap-10 items-center">
      ...
      <div className="py-10 md:w-[50%]">
        <p className="text-3xl font-bold text-secondary py-5">Educationist, Entrepreneur, Social Activist</p>
       ...
       <Link href="/about"> <button className="bg-secondary px-5 py-2 text-white font-bold rounded-full flex mx-auto">Read More</button></Link>
      </div>
    </div>
    </div>
  );
