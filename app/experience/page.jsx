                ...
                >
                  ...
                  <Slide index={7}>
                    <div className="flex flex-shrink-0 relative w-full h-96 sm:w-auto">
                      <div className="z-50 flex flex-col justify-center items-center w-[90%] mx-auto">
                      <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10  "/>
                      Provided advisory services and guidance to YOGDAN and other institutions working towards women&apos;s empowerment, offering expertise in program development, capacity building, and strategic planning.
                      </div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                        <div className="flex h-full items-end pb-6"></div>
                      </div>
                  ...
                  <Slide index={9}>
                    <div className="flex flex-shrink-0 relative w-full h-96 sm:w-auto">
                      <div className="z-50 flex flex-col justify-center items-center w-[90%] mx-auto">
                      <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10  "/>
                      Implemented CARE Programmes in four blocks of Lucknow Districts, focusing on women&apos;s education, healthcare, livelihood opportunities, and community development to uplift the marginalized sections of society.
                      </div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                        <div className="flex h-full items-end pb-6"></div>
                      </div>
                ...
                >
                  <Slide index={0}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                     ...
                     <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10  "/>Appropriate Technology Development Association (A.T.D.A.), Gandhi Bhawan, Lucknow as a programme coordinator, (Nature of job- Implementation of projects of health entrepreneurship, skill development, handicrafts related with women)</div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                  ...
                  <Slide index={1}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                     ...
                     <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10 "/>Worked extensively in TRYSUM Training for rural youths in the block of Mohanlalganj and Chinhat in income generating activities especially chikan work.</div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                  ...
                  <Slide index={2}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                     <div className="z-50 h-[450px] text-center text-xl px-12 py-10 flex flex-col justify-center ">
                     <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10  "/>Supervised STEP Project in two Malin Basti, Deen Dayal Nagar and Naseem Manjil for 30 women at each centre formed than into co-operative societies.</div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                  ...
                  <Slide index={4}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                     <div className="z-50 h-[450px] text-center text-xl px-12 py-10 flex flex-col justify-center ">
                     <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10 "/>Organised several Seminars and meetings for women to make them aware of these legal rights.</div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                  ...
                  <Slide index={8}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                     ...
                     <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10 "/>Implemented CARE Programmes at 4 blocks of Lucknow Districts.</div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
                  ...
                  <Slide index={8}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                     <div className="z-50 h-[450px] text-center text-xl px-12 py-10 flex flex-col justify-center">
                     <BsBriefcaseFill className=" text-4xl z-50 shrink-0 text-blue-500 my-2 mx-auto absolute top-10 "/>26 years experience in library and information services in ATDA (NGO), 20 years experience in women and rural development. Since 1981 working as a librarian and women coordinator with ADTA, Indian Development Group (IDG) & Research and Development in the field of women expowerment.</div>
                      <div className="bg-color bg-opacity-30 absolute w-full h-full p-6">
